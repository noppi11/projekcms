...
<head>
    ...
    <style>
        ...
        p.card-description {
            color: #6c757d; /* Gray color for description text */
            font-size: 1rem;
            margin-bottom: 20px;
        }
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Silahkan Masukkan Data Yang Akan Diubah</p>
                <form class="forms-sample" action="<?= base_url('user/update')?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="level">
                            <option value="Kontributor" <?= ($user->level == 'Kontributor') ? 'selected' : ''; ?>>Kontributor</option>
